...
public class FrontServlet extends HttpServlet {
    ...
    private void addMethodByName(List<Method> methods, Class<?> pageClass, String name) {
        Method method = null;
    ...
    private void process(Route route,
        ...
        addMethodByName(methods, pageClass, "before");
        addMethodByName(methods, pageClass, route.getAction());
        addMethodByName(methods, pageClass, "after");
        ...
        try {
            ...
            throw new ServletException("Can't render template [pageClass=" + pageClass + ", methods=" + methods.size() + "].", e);
        }
    }
